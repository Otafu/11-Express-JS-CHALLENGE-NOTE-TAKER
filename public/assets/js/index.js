...
const saveNote = (note) => axios.post("/api/notes", note);
...
const handleElementRemoval = function () {
  document.querySelector("li", this).remove();
};
...
const renderNoteList = async (jsonNotes) => {
  ...
  const createLi = (text, delBtn = true) => {
    ...
    if (delBtn) {
      ...
      delBtnEl.addEventListener("click", handleElementRemoval);
